<template>
  ...
  <svg aria-hidden="true" width="63.606" height="67.528" viewBox="0 0 63.606 67.528" xmlns="http://www.w3.org/2000/svg"><g id="svgGroup" stroke-linecap="round" fill-rule="evenodd" font-size="9pt" stroke="#000" stroke-width="0.25mm" fill="#000" style="stroke:#000;stroke-width:0.25mm;fill:#000"><path id="path-d" d="M 28 0.012 L 0 0.012 L 0 67.512 L 28 67.512 C 38.1 67.512 46.6 64.312 53.4 57.812 C 60.2 51.312 63.6 43.212 63.6 33.712 C 63.6 24.212 60.2 16.312 53.4 9.812 C 46.6 3.312 38.1 0.012 28 0.012 Z M 28 52.312 L 16.6 52.312 L 16.6 15.312 L 28 15.312 C 33.1 15.312 37.5 17.112 41 20.612 C 44.5 24.112 46.3 28.512 46.3 33.712 C 46.3 38.912 44.5 43.312 41 46.912 C 37.5 50.512 33.2 52.312 28 52.312 Z" vector-effect="non-scaling-stroke"/></g></svg>
  ...
  export default {
    methods: {
      ...
      createSVG(pathID: string, numSamples: number ,x: number, y: number, color: string) {
        ...
        logoVertices = Vertices.scale(logoVertices, 3.5, 3.5, {x: 0, y: 0});
